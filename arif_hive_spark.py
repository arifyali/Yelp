...
features = df.select(df['pricerange'], df['goodforkids'], df['goodforgroup'],
                     df['goodfordessert'], df['goodforlatenight'], df['goodforlunch'],
                     df['goodfordinner'], df['goodforbrunch'], df['goodforbreakfast'],
                     df['romantic'], df['intimate'], df['classy'], df['hipster'],
                     df['divey'], df['touristy'], df['trendy'], df['upscale'],
